...
const LoggedInContainer = ({children, curActiveScreen}) => {
    ...
    return (
        <div className="h-full w-full bg-slight-dark-blue">
            ...
            <div className={`${currentSong ? "h-9/10" : "h-full"} w-full flex`}>
                ...
                <div className="h-full w-1/5 bg-gray-700 flex flex-col justify-between pb-10">
                    <div>
                ...
                <div className="h-full w-4/5 bg-gray-800 overflow-auto">
                    <div className="navbar w-full h-1/10 bg-dark-blue bg-opacity-30 flex items-center justify-end">
